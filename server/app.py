...
app = Flask(__name__)
app.config['SQLALCHEMY_DATABASE_URI'] = 'sqlite:///app.db' #points to our existing database
app.config['SQLALCHEMY_TRACK_MODIFICATIONS'] = False #avoid building up too much unhelpful data in memory when our application is running

migrate = Migrate(app, db) #configures the application and models for Flask-Migrate
